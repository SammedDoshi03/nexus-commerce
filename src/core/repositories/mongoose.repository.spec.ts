...
describe('MongooseRepository', () => {
    ...
    describe('findOne', () => {
        it('should find by id', async () => {
            const expected = { name: 'test' };
            mockModel.findById.mockReturnValue({ exec: jest.fn().mockResolvedValue(expected) });
    ...
    describe('update', () => {
        it('should update by id', async () => {
            ...
            mockModel.findByIdAndUpdate.mockReturnValue({ exec: jest.fn().mockResolvedValue(expected) });
    ...
    describe('delete', () => {
        it('should delete by id', async () => {
            mockModel.findByIdAndDelete.mockReturnValue({ exec: jest.fn().mockResolvedValue({ name: 'deleted' }) });

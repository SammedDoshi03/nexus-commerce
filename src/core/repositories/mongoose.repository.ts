...
export abstract class MongooseRepository<T extends Document> implements IGenericRepository<T> {
    ...
    async findAll(filter?: any, options?: { skip?: number; limit?: number }): Promise<T[]> {
